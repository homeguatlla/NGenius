...
IMaterialEffect* MaterialEffectClippingPlane::AddNewEffectToMaterial(IMaterial* material)
{
	MaterialEffectClippingPlane* materialEffect = new MaterialEffectClippingPlane();
